...
const AboutSection = () => {
  ...
  return <section id="about" className="section-padding bg-slate-100/80 dark:bg-zinc-950/50">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {features.map((feature, index) => <div key={index} className="group bg-card p-6 lg:p-8 rounded-xl border border-border/50 shadow-sm transition-all duration-300 hover:shadow-elegant hover:-translate-y-2 hover:border-primary/30 animate-fade-in-up hover:bg-gradient-to-br hover:from-card hover:to-primary/5" style={{

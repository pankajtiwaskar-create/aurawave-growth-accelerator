...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Linkedin, href: 'https://linkedin.com/company/aurawave-digital', label: 'LinkedIn' },
    { icon: Instagram, href: 'https://instagram.com/aurawavedigital', label: 'Instagram' },
    { icon: Twitter, href: 'https://twitter.com/aurawavedigital', label: 'Twitter' },
  ];
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-muted-foreground">
                ...
                <a 
                  href="mailto:marketing@aurawavedigital.com" 
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold mb-1">Vietnam Office</h4>
                <div className="flex items-center space-x-2 text-muted-foreground">
                  <Phone className="w-4 h-4" />
                  <a 
                ...
                <div className="flex space-x-3">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-white transition-all duration-300 hover:scale-105"
